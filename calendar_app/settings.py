...
SECRET_KEY = 'django-insecure-i=bn*8e8j)72(i31j^zt0ud%b(o=+84av*+xh9j28c_gdy$k^$'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Scheduler API',
    'DESCRIPTION': 'Django REST Framework backend for scheduling and availability management.',
    'VERSION': '1.0.0',
